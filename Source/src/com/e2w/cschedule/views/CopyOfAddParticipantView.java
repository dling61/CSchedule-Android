 ...
 * 
 * */
public class CopyOfAddParticipantView extends RelativeLayout {
	Context context;
...
//	public LinearLayout layout_edit;
	...
	public CopyOfAddParticipantView(Context context) {
		super(context);
		this.context = context;
		findViewById(context);
	}

	public CopyOfAddParticipantView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
		findViewById(context);
	}
