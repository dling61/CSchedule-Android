 ...
 * 
 * */
public class DraftAddScheduleView extends RelativeLayout {
	Context context;
	...
	public DraftAddScheduleView(Context context) {
		super(context);
		this.context = context;
		findViewById(context);
	}

	public DraftAddScheduleView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
		findViewById(context);
	}

	public DraftAddScheduleView(Context context, AttributeSet attrs, int defStyle) {
