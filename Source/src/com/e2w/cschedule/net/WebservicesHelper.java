...
import com.e2w.cschedule.CategoryTabActivity;
import com.e2w.cschedule.MyApplication;
...
import com.e2w.cschedule.interfaces.FeedbackInterface;
...
import com.e2w.cschedule.interfaces.UpdateConfirmStatusInterface;
import com.e2w.cschedule.models.ActivityTable;
import com.e2w.cschedule.models.AppVersionTable;
...
import com.e2w.cschedule.models.TimeZoneTable;
	...
	private void getServerSettingComplete(final Context context,
		...
		try {
			...
			for (int i = 0; i < alertSize; i++) {
				...
				ContentValues cv = new ContentValues();
				cv.put(com.e2w.cschedule.models.AlertTable.aname, alert);
				// if (DatabaseHelper.getSharedDatabaseHelper(context)
				// .isAlertExisted(id) == false) {
				cv.put(com.e2w.cschedule.models.AlertTable.id, id);
				if (DatabaseHelper.getSharedDatabaseHelper(context)
						.insertAlert(cv))
