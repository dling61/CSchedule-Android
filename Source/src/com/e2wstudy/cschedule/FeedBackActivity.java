...
import com.e2wstudy.cschedule.net.BaseUrl;
import com.e2wstudy.cschedule.net.JSONParser;
...
//			Utils.postLeftToRight(mContext);
			...
			if (feedback != null && (!feedback.equals(""))) {
				...
				final ToastDialog dialog = new ToastDialog(mContext,
						mContext.getResources().getString(R.string.please_enter_feedback));
				dialog.show();
			...
			try {
				if (result != null) {
					if (result.contains("200")) {
						final ToastDialog dialog = new ToastDialog(mContext,
								mContext.getResources().getString(R.string.send_feedback_success));
						dialog.show();
						...
						final ToastDialog dialog = new ToastDialog(mContext,
								mContext.getResources().getString(R.string.invalid_content_feedback));
						dialog.show();
